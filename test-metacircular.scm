...
(define (test-eval-apply eval-fn)
  (let ((env the-empty-environment))
    (begin
      ...
      (test "and: t f" #f (eval-fn '(and true false) env))
      (test "and: f t" #f (eval-fn '(and false true) env))
      (test "and: f f" #f (eval-fn '(and false false) env))
      (test "or: t" #t (eval-fn '(or true) env))
      (test "or: f" #f (eval-fn '(or false) env))
      (test "or: t t" #t (eval-fn '(or true true) env))
      (test "or: t f" #t (eval-fn '(or true false) env))
      (test "or: f t" #t (eval-fn '(or false true) env))
      (test "or: f f" #f (eval-fn '(or false false) env))
      )))
