...
(define (test-eval-apply eval-fn)
  (let ((env the-empty-environment))
    (begin
      ...
      (test "cond: null clauses" 'false (eval-fn '(cond) env))
      ...
      (test "and: t" 'true (eval-fn '(and true) env))
      (test "and: f" 'false (eval-fn '(and false) env))
      (test "and: t t" 'true (eval-fn '(and true true) env))
      (test "and: t f" 'false (eval-fn '(and true false) env))
      (test "and: f t" 'false (eval-fn '(and false true) env))
      (test "and: f f" 'false (eval-fn '(and false false) env))
      (test "or: t" 'true (eval-fn '(or true) env))
      (test "or: f" 'false (eval-fn '(or false) env))
      (test "or: t t" 'true (eval-fn '(or true true) env))
      (test "or: t f" 'true (eval-fn '(or true false) env))
      (test "or: f t" 'true (eval-fn '(or false true) env))
      (test "or: f f" 'false (eval-fn '(or false false) env))
      )))
